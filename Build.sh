#!/bin/sh
#
# CannyOS cannyos-application-opensuse-gtk3-gramps container build script
#
# https://github.com/intlabs/cannyos-application-opensuse-gtk3-gramps
#
...
#
clear
curl https://raw.githubusercontent.com/intlabs/cannyos-application-opensuse-gtk3-gramps/master/CannyOS/CannyOS.splash
#     *****************************************************
#     *                                                   *
#     *        _____                    ____  ____        *
...
sudo mkdir -p "/CannyOS/build/cannyos-application-opensuse-gtk3-gramps"
# Ensure that there it is clear
sudo rm -r -f "/CannyOS/build/cannyos-application-opensuse-gtk3-gramps/*"
